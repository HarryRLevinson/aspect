...
#ifndef _aspect_particle_generator_reference_cell_random_h
#define _aspect_particle_generator_reference_cell_random_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Generator
    {
       ...
       */
      template <int dim>
      class ReferenceCellRandom : public Interface<dim>
      {
        public:
          /**
           * Generate a uniform distribution of particles in the unit cell and transforms
        ...
        private:
           ...
           */
          std::vector<Point<dim> > generate_random_particle_positions_in_unit_cell(int seed_for_random_number_generator);

          /**
           * Number of particles to randomly place in each cell, as
           * specified within the parameter file.
           */
          int number_of_particles_per_cell;
      };
